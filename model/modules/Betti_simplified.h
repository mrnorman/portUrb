...
struct Floating_motions_betti {
  ...
  // TODO: For U19_5, accumulate some time average, and average spatially ever something-th time step to update
  //       Min frequency is 0.1 or a period of 10s, so consider 10s as the time-averaging period
