...
prefixes_fixed = [ "turbulent_3x3_wind-3.000000_fixed-_"  ,\
                   "turbulent_3x3_wind-4.000000_fixed-_"  ,\
                   "turbulent_3x3_wind-5.000000_fixed-_"  ,\
                   "turbulent_3x3_wind-6.000000_fixed-_"  ,\
                   "turbulent_3x3_wind-7.000000_fixed-_"  ,\
                   "turbulent_3x3_wind-8.000000_fixed-_"  ,\
                   "turbulent_3x3_wind-9.000000_fixed-_"  ,\
                   "turbulent_3x3_wind-10.000000_fixed-_" ,\
                   "turbulent_3x3_wind-11.000000_fixed-_" ,\
                   "turbulent_3x3_wind-12.000000_fixed-_" ,\
                   "turbulent_3x3_wind-13.000000_fixed-_" ,\
                   "turbulent_3x3_wind-14.000000_fixed-_" ,\
                   "turbulent_3x3_wind-15.000000_fixed-_" ,\
                   "turbulent_3x3_wind-16.000000_fixed-_" ,\
                   "turbulent_3x3_wind-17.000000_fixed-_" ,\
                   "turbulent_3x3_wind-18.000000_fixed-_" ,\
                   "turbulent_3x3_wind-19.000000_fixed-_" ,\
                   "turbulent_3x3_wind-20.000000_fixed-_" ,\
                   "turbulent_3x3_wind-21.000000_fixed-_" ,\
                   "turbulent_3x3_wind-22.000000_fixed-_" ,\
                   "turbulent_3x3_wind-23.000000_fixed-_" ,\
                   "turbulent_3x3_wind-24.000000_fixed-_" ,\
                   "turbulent_3x3_wind-25.000000_fixed-_" ]

prefixes_float = [ "turbulent_3x3_wind-3.000000_floating-_"  ,\
                   "turbulent_3x3_wind-4.000000_floating-_"  ,\
                   "turbulent_3x3_wind-5.000000_floating-_"  ,\
                   "turbulent_3x3_wind-6.000000_floating-_"  ,\
                   "turbulent_3x3_wind-7.000000_floating-_"  ,\
                   "turbulent_3x3_wind-8.000000_floating-_"  ,\
                   "turbulent_3x3_wind-9.000000_floating-_"  ,\
                   "turbulent_3x3_wind-10.000000_floating-_" ,\
                   "turbulent_3x3_wind-11.000000_floating-_" ,\
                   "turbulent_3x3_wind-12.000000_floating-_" ,\
                   "turbulent_3x3_wind-13.000000_floating-_" ,\
                   "turbulent_3x3_wind-14.000000_floating-_" ,\
                   "turbulent_3x3_wind-15.000000_floating-_" ,\
                   "turbulent_3x3_wind-16.000000_floating-_" ,\
                   "turbulent_3x3_wind-17.000000_floating-_" ,\
                   "turbulent_3x3_wind-18.000000_floating-_" ,\
                   "turbulent_3x3_wind-19.000000_floating-_" ,\
                   "turbulent_3x3_wind-20.000000_floating-_" ,\
                   "turbulent_3x3_wind-21.000000_floating-_" ,\
                   "turbulent_3x3_wind-22.000000_floating-_" ,\
                   "turbulent_3x3_wind-23.000000_floating-_" ,\
                   "turbulent_3x3_wind-24.000000_floating-_" ,\
                   "turbulent_3x3_wind-25.000000_floating-_" ]

nc_fixed = [xarray.open_mfdataset([prefix+"000000"+str(i).zfill(2)+".nc" for i in range(1,2)],concat_dim="num_time_steps",combine="nested") for prefix in prefixes_fixed]
nc_float = [xarray.open_mfdataset([prefix+"000000"+str(i).zfill(2)+".nc" for i in range(1,2)],concat_dim="num_time_steps",combine="nested") for prefix in prefixes_float]
...
yaw_std_fixed   = np.array([0. for i in range(N)])
yaw_std_float   = np.array([0. for i in range(N)])
