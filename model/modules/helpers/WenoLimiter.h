...
namespace limiter {
  ...
  template <class T>
  YAKL_INLINE void convexify(T & w1, T & w2, T & w3, T & w4, T & w5, T & w6, T & w7) {
  ...
  template <class T>
  YAKL_INLINE void convexify(T & w1, T & w2, T & w3, T & w4, T & w5, T & w6, T & w7, T & w8) {
  ...
  template <class real> struct WenoLimiter<real,13> {
    ...
    YAKL_INLINE static void compute_limited_edges( SArray<real,1,13>      &s         ,
                                                   real                   &qL        ,
                                                   real                   &qR        ,
                                                   Params           const &params_in ) {
    ...
    YAKL_INLINE static real gll_1(real TV_1, real TV_2, real TV_3, real TV_4, real TV_5, real TV_6, real TV_7, bool do_map, SArray<real,1,13> const &s) {
    ...
    YAKL_INLINE static real gll_2(real TV_1, real TV_2, real TV_3, real TV_4, real TV_5, real TV_6, real TV_7, bool do_map, SArray<real,1,13> const &s) {
    ...
    // Don't allow the stencil that doesn't contain the left interface to dominate
    YAKL_INLINE static void imm_L_alter( real &TV_1 , real &TV_2 , real &TV_3 , real &TV_4 , real &TV_5 , real &TV_6 , real &TV_7 ) {
      TV_7 = std::max(std::max(std::max(std::max(std::max(std::max(TV_1,TV_2),TV_3),TV_4),TV_5),TV_6),TV_7);
    }

    // Don't allow the stencil that doesn't contain the right interface to dominate
    YAKL_INLINE static void imm_R_alter( real &TV_1 , real &TV_2 , real &TV_3 , real &TV_4 , real &TV_5 , real &TV_6 , real &TV_7 ) {
  ...
  template <class real> struct WenoLimiter<real,15> {
    ...
    YAKL_INLINE static void compute_limited_edges( SArray<real,1,15>      &s         ,
                                                   real                   &qL        ,
                                                   real                   &qR        ,
                                                   Params           const &params_in ) {
    ...
    YAKL_INLINE static real gll_1(real TV_1, real TV_2, real TV_3, real TV_4, real TV_5, real TV_6, real TV_7, real TV_8, bool do_map, SArray<real,1,15> const &s) {
    ...
    YAKL_INLINE static real gll_2(real TV_1, real TV_2, real TV_3, real TV_4, real TV_5, real TV_6, real TV_7, real TV_8, bool do_map, SArray<real,1,15> const &s) {
    ...
    // Don't allow the stencil that doesn't contain the left interface to dominate
    YAKL_INLINE static void imm_L_alter( real &TV_1 , real &TV_2 , real &TV_3 , real &TV_4 , real &TV_5 , real &TV_6 , real &TV_7 , real &TV_8 ) {
      TV_8 = std::max(std::max(std::max(std::max(std::max(std::max(std::max(TV_1,TV_2),TV_3),TV_4),TV_5),TV_6),TV_7),TV_8);
    }

    // Don't allow the stencil that doesn't contain the right interface to dominate
    YAKL_INLINE static void imm_R_alter( real &TV_1 , real &TV_2 , real &TV_3 , real &TV_4 , real &TV_5 , real &TV_6 , real &TV_7 , real &TV_8 ) {
